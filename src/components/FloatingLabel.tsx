        ...
        <div className="day-night-toggle">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="12" cy="12" r="10" fill="#87CEEB" stroke="#87CEEB" strokeWidth="1"/>
              <circle cx="12" cy="12" r="5" fill="#FFD700" stroke="#FFD700" strokeWidth="1"/>
              <path d="M12 1v3M12 20v3M23 12h-3M4 12H1M19.07 4.93l-2.12 2.12M6.05 17.95l-2.12 2.12M19.07 19.07l-2.12-2.12M6.05 6.05l-2.12-2.12" stroke="#FFD700" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </button>
          <button
